...
function generateWhatsappLink($nomor_telepon, $nama)
{
    ...
    $link_whatsapp = 'https://wa.me/' . $nomor_telepon . '?text=Assalamualaikum Wr. Wb. %0A B/I. ' . $nama . ', Apakah ada waktu yang bisa saya gunakan untuk berkomunikasi?'; // membuat link WhatsApp dengan pesan "hallo"
