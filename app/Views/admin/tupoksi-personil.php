...
<main class="ms-sm-auto p-md-4 pb-md-0">
    <div class="container-fluid bg-light px-4 rounded">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
            <h1 class="h4 id-table" data-bakalslug="struktur-desa">Tugas Pokok dan Fungsi <?= $jabatan ?></h1>
        </div>
    </div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">:</th>
                        <th scope="col"><?= $personildesa['jabatan'] ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>Nama</td>
                        <td>:</td>
                        <td><?= $personildesa['nama'] ?></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>:</td>
                        <td><?= $personildesa['alamat'] ?></td>
                    </tr>
                    <tr>
                        <td>pendidikan</td>
                        <td>:</td>
                        <td><?= $personildesa['pendidikan'] ?></td>
                    </tr>
                    <tr>
                        <td>No Hp (WhatsApp)</td>
                        <td>:</td>
                        <td><?= $personildesa['kontak'] ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <form action="/adm-proses/update-lembaga/<?= convertToLetter($tupoksi['id']) ?>" method="post">
        <div class="card border-primary mb-3">
            <?= csrf_field() ?>
            ...
            <!-- Khusus di tupoksi -->
            <input type="hidden" name="khusustupoksipersonil" value="<?= convertToLetter($personildesa['id']) ?>">

            <div class="card-header bg-primary text-white">
                <span class="d-inline text-white fs-5">Tugas Pokok & Fungsi <?= $jabatan ?></span>
